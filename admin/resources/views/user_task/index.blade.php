...
@section('content')
    ...
    <div class="form-modal-ex position-relative">
        ...
        <a href="javascript:void(0);" data-url="" class="btn btn-outline-primary add-user-btn js_add_btn">add userTask</a>
        <h3 class="text-center text-primary position-absolute" style="z-index: 1; left: 45%; top: 12px;"> User Tasks</h3>
        <!-- Modal -->
    </div>
