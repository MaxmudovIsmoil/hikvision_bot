...
include_once 'libs/Telegram.php';
...
class Bot
{
    ...
    public function check_chatId($phone)
    {
        ...
        $sql = "SELECT id, username, chat_id, phone FROM users where phone = '".$phone."' LIMIT 1";
    ...
    public function user_done()
    {
        ...
        if ($this->telegram->Callback_Data()) {
            ...
            $sqlInsert = "INSERT INTO `task_done`(`id`, `user_id`, `task_id`, `status`, `confirmation_time`, `created_date`) VALUES(NULL, '".$user_id."', '".$task_id."', '".$status."', '".$confirmation_time."', NOW())";
